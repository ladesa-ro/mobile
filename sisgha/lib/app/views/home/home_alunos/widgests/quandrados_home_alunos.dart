...
import 'cards_horarios_alunos.dart';

class QuandradosHomeAlunos extends StatefulWidget {
  const QuandradosHomeAlunos({super.key});

  @override
  State<QuandradosHomeAlunos> createState() => _QuadradosHomeState();
}

class _QuadradosHomeState extends State<QuandradosHomeAlunos>
            ...
            child: TabBarView(
              ...
              children: const [
                ConstrutorHorariosAlunos(
                  materia: 'Redes',
                  turma: '3°A informática - sala 25',
                  horarioAluno: '10:20 - 11:10',
                ),
                ConstrutorHorariosAlunos(
                  materia: 'Redes',
                  turma: '3°A informática - sala 25',
