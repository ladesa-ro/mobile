...
class _HomeState extends State<Home> {
  ...
  Widget build(BuildContext context) {
    ...
    //String formattedFirstDayOfWeek = portugueseDateFormat.format(firstDayOfWeek)[0].toUpperCase() + portugueseDateFormat.format(firstDayOfWeek).substring(1) + ' ' + DateFormat('dd').format(firstDayOfWeek);
    //String formattedLastDayOfWeek = DateFormat('dd').format(lastDayOfWeek);

    //String formattedYear = DateFormat('yyyy').format(now);

    // String formattedDate ='$formattedFirstDayOfWeek - $formattedLastDayOfWeek, $formattedYear';
