...
class ConstrutorHorariosAlunos extends StatefulWidget {
  ...
  final String turma;
  final String horarioAluno;

  const ConstrutorHorariosAlunos({
    super.key,
    required this.materia,
    required this.turma,
    required this.horarioAluno,
  });

  @override
  State<ConstrutorHorariosAlunos> createState() => _ConstrutorHorariosState();
}

class _ConstrutorHorariosState extends State<ConstrutorHorariosAlunos> {
  @override
        ...
        child: ListView.builder(
          ...
          itemBuilder: (context, index) {
            return disciplinaalunos(
                widget.materia, widget.turma, widget.horarioAluno, context);
          },
        ),
      ),
    );
