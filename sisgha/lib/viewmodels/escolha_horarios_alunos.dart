...
import 'package:sisgha/domain/model/cursos.dart';
import 'package:sisgha/domain/model/nivel_formacao.dart';
...
class EscolhaHorariosAlunos extends ChangeNotifier {
  ...
  Future<void> pucharOpcoes() async {
  ...
  Future<void> selecionarCurso(String? value) async {
    if (value == null || value == '') {
      cursoSelecionado = null;
      turmaSelecionada = null;
      listaTurmas.clear();
