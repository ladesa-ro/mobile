...
import 'package:sisgha/views/login/boas_vindas.dart';
...
import 'package:sisgha/views/login/login/login.dart';
import 'package:sisgha/views/professor/perfil/perfil.dart';
import 'package:sisgha/views/login/splash_screen.dart';
