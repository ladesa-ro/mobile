...
class CoresClaras {
  ...
  static const Color roxoCalendario = Color(0XFF5300A6);

  static const Color background = Color(0xFFFFFFFF);
  static final Color verdeFraco = const Color(0XFF2F9E41).withOpacity(0.2);
...
class CoresEscuras {
  ...
  static final Color verdeFraco = const Color(0XFF066436).withOpacity(0.2);
